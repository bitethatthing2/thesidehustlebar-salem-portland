...
export async function POST(request: NextRequest) {
  try {
    ...
    switch (action) {
      ...
      case 'comment':
        return await handleCommentAction(supabase, videoId, userId, content, parentId);
      case 'follow':
...
async function handleLikeAction(supabase: any, videoId: string, userId: string) {
  try {
...
async function handleUnlikeAction(supabase: any, videoId: string, userId: string) {
  try {
    // Remove like
...
async function handleFollowAction(supabase: any, followerId: string, targetUserId: string) {
  try {
...
async function handleUnfollowAction(supabase: any, followerId: string, targetUserId: string) {
  try {
